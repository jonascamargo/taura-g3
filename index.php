...
?>
        ...
        <section class="flat-spacing pt-0">
            <div class="container">
                <div class="flat-sw-navigation flat-spacing bg-surface radius-20 px_15">
                    <div dir="ltr" class="swiper tf-sw-testimonial" data-preview="1" data-tablet="1" data-mobile="1"
                        data-space-lg="30" data-space-md="30" data-space="15" data-pagination="1" data-pagination-md="1"
                        data-pagination-lg="1">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="testimonial-item-v2 type-space-2 text-center">
                                    <div class="quote-box">
                                        <span class="icon icon-quote"></span>
                                        <div class="text-btn-uppercase text-secondary-2">Customer Say!</div>
                                    </div>
                                    <h4>"Fantastic shop! Great selection, fair prices, and friendly staff. Highly
                                    ...
                                    <div class="rate-box">
                                        ...
                                        <h6>Lisa K. <span class="text-title text-se">/ Stylist</span></h6>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="testimonial-item-v2 type-space-2 text-center">
                                    ...
                                    <div class="rate-box">
                                        ...
                                        <h6>Lisa K. <span class="text-title">/ Stylist</span></h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="nav-prev-testimonial d-none d-lg-flex nav-sw style-line nav-sw-left space-md">
                        <i class="icon icon-arrLeft"></i>
                    </div>
                    <div class="nav-next-testimonial d-none d-lg-flex nav-sw style-line nav-sw-right space-md">
